...
const Register = () => {
    ...
    useEffect(() => {
        if (user) {
            navigate(user.role === 'chef' ? '/chef/dashboard' : '/');
        }
    }, [user, navigate]);
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div className="pt-2 pb-2 px-3 border border-gray-300 rounded-b-md">
                    ...
                    <div className="text-center text-sm text-gray-600">
                        Already have an account? <Link to="/login" className="font-medium text-orange-600 hover:text-orange-500">Log in here</Link>
                    </div>
                </form>
            </div>
        </div>
